            ...
            <div class="card-body p-lg-5 p-0">
                <div class="p-4">
                    <div class="text-center mb-4">
                        <h1 class="h4 text-gray-900"><img src="assets/img/kai1.png" width="40px">Pengelolaan Aset</h1>
                    ...
                    <div class="form-groub">
                            <div class="form-group">
                                <input value="<?= set_value('NIP'); ?>" type="text" name="NIP" class="form-control form-control-user" placeholder="NIP">
