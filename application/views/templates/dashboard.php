		...
		<ul class="navbar-nav bg-white sidebar sidebar-light accordion shadow-sm" id="accordionSidebar">
			...
			<a class="sidebar-brand d-flex text-white align-items-center bg-primary justify-content-center" href="<?= base_url('dashboard'); ?>">
				...
				<div class="sidebar-brand-icon">
					...
					<i aria-hidden="true"><img src="<?= base_url(); ?>assets/img/kai1.png" width="55"></i>
				</div>
				<div class="sidebar-brand-text mx-3">Pengelolaan</div>
			</a>
			<!-- Nav Item - Dashboard -->
			<li class="nav-item">
			...
			<li class="nav-item">
				...
				<div id="collapseMaster" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
					<div class="bg-light py-2 collapse-inner rounded">
						...
						<a class="collapse-item" href="<?= base_url('kondisi'); ?>">Condition</a>
						<a class="collapse-item" href="<?= base_url('gudang'); ?>">Werehouse</a>
						<a class="collapse-item" href="<?= base_url('barang'); ?>">Inventory</a>
						<a class="collapse-item" href="<?= base_url('inventory'); ?>">Inventory 2</a>
					</div>
				</div>
			</li>
			...
			<footer class="sticky-footer bg-light">
				<div class="container my-auto">
					<div class="copyright text-center my-auto">
						<span>Copyright &copy; PT KAI Daop 5 Purwokerto &bull; 2023 &bull; </span>
					</div>
				</div>
			</footer>
			<!-- End of Footer -->
   ...
   <script src="https://code.jquery.com/jquery-3.3.1.min.js"></script>
	...
	<?php if ($this->uri->segment(1) == 'dashboard') : ?>
		...
		<script type="text/javascript">
            ...
            var myPieChart2 = new Chart(ctx1, {
                type: 'doughnut',
                data: {
			...
			<?php
				if ($gudang) :
					foreach ($gudang as $g) :
			?>
			var ctxZ + <?= $g['id_gudang'] ?> = document.getElementById("<?= $g['id_gudang']; ?>");
			console.log('ctx ', ctxZ)
			let getStatusCount = <?= getCountStatus($g['id_gudang'], '1') ?>;
			console.log('count', getStatusCount);
			var myPieChartZ = new Chart(ctxZ + <?= $g['id_gudang'] ?>, {
				type: 'doughnut',
				data: {
					labels: ["Baik", "Rusak", "Afkir"],
					datasets: [{
						data: [<?= getCountStatus($g['id_gudang'], '1') ?>, <?= getCountStatus($g['id_gudang'], '2') ?>, <?= getCountStatus($g['id_gudang'], '3') ?>],
						backgroundColor: ['#4e73df', '#e74a3b'],
						hoverBackgroundColor: ['#5a5c69', '#5a5c69'],
						hoverBorderColor: "rgba(234, 236, 244, 1)",
					}],
		...
		<script>
			$(function() {
				...
				//bar chart data
				var data = {
					labels: cData.nama_status,
					datasets: [{
						label: cData.nama_gudang,
						data: cData,
						backgroundColor: [
							"#DEB887",
							"#A9A9A9",
