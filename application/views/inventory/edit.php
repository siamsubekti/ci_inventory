        ...
        <div class="card shadow-sm border-bottom-primary">
            ...
            <div class="card-body">
				...
				<div class="row form-group">
                    ...
                    <div class="col-md-9">
                        <input value="<?= set_value('kode_barang', $inventory['kode_barang']); ?>" name="kode_barang" id="kode_barang" type="text" class="form-control" placeholder="Kode Barang...">
				...
				<div class="row form-group">
                    ...
                    <div class="col-md-9">
                        <input value="<?= set_value('serial_number', $inventory['serial_number']); ?>" name="serial_number" id="serial_number" type="text" class="form-control" placeholder="Serial Number...">
				...
				<div class="row form-group">
                    ...
                    <div class="col-md-9">
                        <input value="<?= set_value('no_invoice', $inventory['no_invoice']); ?>" name="no_invoice" id="no_invoice" type="text" class="form-control" placeholder="No Invoice...">
                ...
                <div class="row form-group">
                    ...
                    <div class="col-md-9">
                        <input value="<?= set_value('nama_barang', $inventory['nama_barang']); ?>" name="nama_barang" id="nama_barang" type="text" class="form-control" placeholder="Nama Barang...">
				...
				<div class="row form-group">
                    ...
                    <div class="col-md-9">
                        <input value="<?= set_value('jumlah', $inventory['jumlah']); ?>" name="jumlah" id="jumlah" type="text" class="form-control" placeholder="Jumlah...">
                        ...
                        <div class="input-group">
                            <select name="status_id" id="status_id" class="custom-select">
                                ...
                                <?php foreach ($status as $j) : ?>
                                    <option <?= set_select('status_id', $j['id_status']) ?> value="<?= $j['id_status'] ?>"><?= $j['nama_status'] ?></option>
                                <?php endforeach; ?>
                            </select>
                            <div class="input-group-append">
				...
				<div class="row form-group">
                    <label class="col-md-4 text-md-right" for="tanggal_pemeriksaan">Tanggal Pemeriksaan</label>
                    <div class="col-md-4">
